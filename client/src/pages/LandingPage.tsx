...
import { User, LogIn, Shield, MapPin, Users, FlaskConical } from "lucide-react";
    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#f8fafc" }}>
      ...
      >
        ...
        >
          ...
          <h1
            style={{
              fontSize: "clamp(3.75rem, 8.5vw, 6rem)",
            ...
            aria-label="TrueRoots brand heading"
          >
            TrueRoots
          </h1>
          ...
          */}
          ...
          >
            Join the TrueRoots ecosystem and start your journey in transparent
            herb traceability
          </p>
        </div>
      </section>
      ...
      >
        ...
        >
          ...
          <div style={{ marginBottom: "4rem" }}>
            ...
            >
              Revolutionizing Ayurvedic herb traceability with cutting-edge
              technology
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Every herb batch is recorded on blockchain for immutable traceability",
              },
              {
                icon: MapPin,
                title: "GPS Tracking",
                description:
                  "Real-time location tracking from collection to consumer",
              },
              {
                icon: Users,
                title: "Community Driven",
                description:
                  "Supporting local collectors and traditional knowledge",
              },
              {
                icon: FlaskConical,
                title: "AI-Powered Verification",
                description:
                  "Advanced AI analyzes herb photos and stores verification data on IPFS for authenticity",
              },
            ].map((feature, index) => {
